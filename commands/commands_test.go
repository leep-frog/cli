...
func TestExecute(t *testing.T) {
	for _, test := range []struct {
		...
		},
		{
			...
			wantStderr: []string{`not enough arguments provided for "state"`},
		},
		{
		...
		{
			name:       "not enough positional arguments when partial list",
			args:       []string{"intermediate", "--state", "maine", "one"},
			wantStderr: []string{`not enough arguments provided for "syllable"`},
		},
		{
			name:       "not enough positional arguments when empty list",
			args:       []string{"basic", "--state", "maine"},
			wantStderr: []string{`not enough arguments provided for "val_1"`},
		},
		{
		...
		// Test lists
		{
			...
			wantStderr: []string{`not enough arguments provided for "list-arg"`},
		},
		{
		...
		// Test extra optional arguments.
		{
			...
			wantStderr: []string{`not enough arguments provided for "opt group"`},
		},
		{
		...
		},
		{
			...
			args:       []string{"valueTypes", "int", "123.45"},
			wantStderr: []string{`argument should be an integer: strconv.Atoi: parsing "123.45": invalid syntax`},
		},
		{
		...
		},
		{
			...
			wantStderr: []string{`strconv.Atoi: parsing "123.45": invalid syntax`},
		},
		{
		...
		},
		{
			...
			wantStderr: []string{`argument should be a float: strconv.ParseFloat: parsing "twelve": invalid syntax`},
		},
		{
		...
		},
		{
			...
			wantStderr: []string{`argument should be a bool: strconv.ParseBool: parsing "maybe": invalid syntax`},
		},
		{
		...
		// ArgOpt tests
		{
			...
			wantStderr: []string{"option can only be bound to arguments with type 3"},
		},
		// Contains
		{
			name: "Contains works",
		...
		},
		{
			...
			wantStderr: []string{"validation failed: [IntNE] value isn't not equal to 25"},
		},
		// IntLT
		{
			name: "IntLT works",
		...
		},
		{
			...
			wantStderr: []string{"validation failed: [FloatEQ] value isn't equal to 24.00"},
		},
		// FloatNE
		{
			name: "FloatNE works",
		...
		},
		{
			...
			wantStderr: []string{"validation failed: [FloatNE] value isn't not equal to 25.00"},
		},
		// FloatLT
		{
			name: "FloatLT works",
		...
		},
		{
			...
			wantStderr: []string{"validation failed: [FloatLT] value isn't less than 25.00"},
		},
		{
		...
		},
		{
			...
			wantStderr: []string{"validation failed: [FloatLTE] value isn't less than or equal to 25.00"},
		},
		// FloatGT
		{
			...
			wantStderr: []string{"validation failed: [FloatGT] value isn't greater than 25.00"},
		},
		{
		...
		// FloatGTE
		{
			...
			wantStderr: []string{"validation failed: [FloatGTE] value isn't greater than or equal to 25.00"},
		},
		{
